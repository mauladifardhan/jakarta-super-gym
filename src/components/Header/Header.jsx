  ...
  return (
    <div className="header">
      ...
      {menuOpened === false && mobile === true ? (
        <div style={{ backgroundColor: "var(--appSwim)", padding: "0.5rem", borderRadius: "5px" }} onClick={() => setMenuOpened(true)}>
          <img src={Bars} alt="" style={{ width: "1.2rem", height: "1.2rem" }} />
        </div>
      ) : (
        <ul className="header-menu">
          <li>
          <Link onClick={() => setMenuOpened(false)} to="header" spy={true} 
          activeClass="active" smooth={true}>
              Home
            </Link>
          </li>
          <li>
